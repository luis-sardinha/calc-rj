...
function formatarValorEmReais(valor) {
  ...
  function calculate() {
    ...
    var resultText =
     ...
     '<tr><td>União estável (regime diverso)</td><td>' + formatarValorEmReais(valorSemAdd) + '</td></tr>' +
  ...
  function exportarParaExcel() {
    ...
    XLSX.writeFile(workbook, 'Resumo_União_estável(Diverso).xlsx');
  }
