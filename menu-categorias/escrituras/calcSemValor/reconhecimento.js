...
function formatarValorEmReais(valor) {
  ...
  function calculate() {
    ...
    var resultText =
     ...
     '<tr><td>Escritura Pública sem valor declarado</td><td>' + formatarValorEmReais(valorSemAdd) + '</td></tr>' +
  ...
  function exportarParaExcel() {
    ...
    XLSX.writeFile(workbook, 'Resumo_Reconhecimento_paternidade.xlsx');
}
  ...
  function imprimirResultado() {
    ...
    janelaImpressao.document.write('<img class="logo" src="file:///C:/Dev/calc-rj-final/images/Logo_Empresa.png" alt="Logo da Empresa"><br>');
