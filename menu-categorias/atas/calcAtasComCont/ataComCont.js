...
function formatCurrency(input) {
  ...
  function calculate() {
    ...
    var emolumentos = valorTabela + fetj + funperj + funperj + funarpen + pmcmv + distribuicao + iss + selo + atoeletronico; 
  
    
    var resultText =
        '<strong>Cobrança detalhada:</strong><br>' +
        '<table class="excel-style">' +
        '<tr><td>Ata Notarial</td><td>' + formatarValorEmReais(valorTabela) + '</td></tr>' +
